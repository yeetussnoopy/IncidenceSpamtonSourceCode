local movingarenaAttack, super = Class(Wave)

function movingarenaAttack:init()
    super:init(self)
...
function movingarenaAttack:onStart()
...
function movingarenaAttack:update()
   ...
   -- Game.battle.arena:setPosition(self.arena_start_x, self.arena_start_y + offset)
        ...
        Game.battle.arena:setPosition(self.arena_start_x - offset, self.arena_start_y + offset)
